...
func TestBastionDefaultVPC(t *testing.T) {
	t.Parallel()
	...
	test_structure.RunTestStage(t, "setup", func() {
		terraformOptions := configureTerraformOptionsBastionDefaultVPC(t, exampleFolder)
...
func configureTerraformOptionsBastionDefaultVPC(t *testing.T, exampleFolder string) *terraform.Options {
	...
	environmentName := fmt.Sprintf("terratest-bastion-default-vpc-%s", uniqueID)
