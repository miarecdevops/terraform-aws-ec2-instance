...
func TestRoute53(t *testing.T) {
	...
	exampleFolder := test_structure.CopyTerraformFolderToTemp(t, "../", "examples/route53")
	...
	test_structure.RunTestStage(t, "setup", func() {
		terraformOptions := configureTerraformOptionsRoute53(t, exampleFolder)
...
func configureTerraformOptionsRoute53(t *testing.T, exampleFolder string) *terraform.Options {
	...
	environmentName := fmt.Sprintf("terratest-instance-route53-%s", uniqueID)
