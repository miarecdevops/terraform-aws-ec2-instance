...
func TestCustomVPC(t *testing.T) {
	...
	exampleFolder := test_structure.CopyTerraformFolderToTemp(t, "../", "examples/custom-vpc")
	...
	test_structure.RunTestStage(t, "setup", func() {
		terraformOptions := configureTerraformOptionsCustomVPC(t, exampleFolder)
...
func configureTerraformOptionsCustomVPC(t *testing.T, exampleFolder string) *terraform.Options {
	...
	environmentName := fmt.Sprintf("terratest-instance-custom-vpc-%s", uniqueID)
